...
query = {
    "statements": [
        {
            "statement": """
            MATCH (n)-[r]-(connected)
            WHERE id(n) IN [232, 227, 66, 60, 212, 230, 72, 28, 214, 224, 67, 69, 216, 63, 215, 217, 225, 
    213, 236, 234, 237, 74, 65, 70, 231, 412, 233, 235, 238, 239, 240, 241, 242, 
    243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 
    258, 259, 260, 261, 262, 263, 264, 267, 268, 269, 270, 271, 272, 273, 274, 
    275, 276, 277, 278, 279, 280, 281, 282, 283, 284, 285, 286, 287, 288, 289, 
    290, 291, 292, 293, 294, 298, 296, 297, 295, 299, 300, 301, 302, 303, 304, 
    ...
    395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 265, 266, 406, 407, 
    408, 409, 410, 411]
...
try:
    ...
    response.raise_for_status()  # examine if there is any HTTP error
    results = response.json()
    print("Query results received.")
    

    # extract and save results as TXT file
    with open('connected_nodes_NEW.txt', mode='w') as txt_file:
        for result in results['results']:
            ...
            for row in data:
                ...
                txt_file.write("-" * 40 + "\n")
    print("Results saved to connected_nodes_NEW.txt")
